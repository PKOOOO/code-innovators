...
function ArrowIcon({ color }: { color: string }) {
    return (
        <div
            className="flex items-center justify-center w-36 h-36 sm:w-44 sm:h-44 rounded-3xl shrink-0"
...
export default function SponsorCTA() {
    return (
        <section className="bg-background px-4 sm:px-6 md:px-12 lg:px-16 py-20 md:py-28">
            {/* Heading pill */}
            <div className="mb-10">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <Link
                    href="/sponsor"
                    className="group flex flex-row items-center justify-between gap-6 min-h-[280px] sm:min-h-[320px] bg-white/5 hover:bg-[#8b7ff5] border border-white/10 hover:border-[#8b7ff5] rounded-3xl px-8 py-10 sm:px-10 sm:py-12 transition-all duration-300"
                >
                ...
                <Link
                    ...
                    className="group flex flex-row items-center justify-between gap-6 min-h-[280px] sm:min-h-[320px] bg-white/5 hover:bg-[#00e6b4] border border-white/10 hover:border-[#00e6b4] rounded-3xl px-8 py-10 sm:px-10 sm:py-12 transition-all duration-300"
                >
                    <div className="flex flex-col gap-8">
                        <h2 className="font-display text-3xl sm:text-4xl font-semibold text-white group-hover:text-black leading-tight transition-colors duration-300">
