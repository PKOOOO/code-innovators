        ...
        <nav className="absolute top-0 left-0 right-0 z-50 px-6 md:px-12 py-5">
            <div className="max-w-7xl mx-auto flex items-center justify-between">
                ...
                <div className="flex items-center gap-3">
                    ...
                    <Link
                        href="#register"
                        className="inline-flex items-center px-5 py-2 rounded-full bg-accent text-background text-sm font-bold hover:bg-accent-hover transition-all duration-200 shadow-lg shadow-accent/20"
                    >
                        Buy tickets
                    </Link>
                </div>
