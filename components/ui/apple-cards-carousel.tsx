...
export const Carousel = ({ items, initialScroll = 0 }: CarouselProps) => {
  ...
  const handleCardClose = (index: number) => {
    if (carouselRef.current) {
      const cardWidth = isMobile() ? 288 : 480; // (md:w-[30rem])
        ...
        {open && (
          <div className="fixed inset-0 z-50 overflow-y-auto">
            ...
            <motion.div
              ...
              ref={containerRef}
              className="relative z-[60] w-full max-w-5xl h-fit rounded-3xl bg-white p-4 font-sans md:p-10 dark:bg-neutral-900"
            >
              <button
